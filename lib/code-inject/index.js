...
exports.insertCodeToScript = insertCodeToScript;
exports.insertImportCode = insertImportCode;
exports.insertCodeToMethod = insertCodeToMethod;
 ...
 */
function insertCodeToScript(originCode, insert) {
 ...
 *  向js文件顶部插入组件引入代码
 */
function insertImportCode(originCode, importsCode) {
 ...
 *  向方法里面插入代码
 */
function insertCodeToMethod(originCode, injectCode) {
    const ast = util.parse2AST(originCode);
    traverse(ast, {
        ClassMethod(path) {
