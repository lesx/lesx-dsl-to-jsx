...
exports.default = ({
    ...
    if (Array.isArray(undeclaredVars) && undeclaredVars.length) {
        undeclaredVars = difference(undeclaredVars, getLibRes.libComponentTags.concat(['React', 'Component', 'ReactDom', 'undefined', 'null', 'window', 'NaN', 'Infinity', 'module', 'Object', 'Array', 'Function', 'String', 'Boolean', 'RegExp', 'console']));
